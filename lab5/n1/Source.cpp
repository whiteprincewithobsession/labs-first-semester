...
int main() {
	...
	while (true) {
		...
		while (stringLength(inputValidation) > 1 || (inputValidation[0] != '1' && inputValidation[0] != '2' && inputValidation[0] != '3' && inputValidation[0] != '4' && inputValidation[0] != '5' && inputValidation[0] != '6')) {
